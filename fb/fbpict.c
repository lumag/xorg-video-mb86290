			       ...
			       CARD16     height)
{
	...
	while (w--)
	{
		...
		{
		    FbDoWrite32 (__tmp, *dst, dst);
		    __tmp = fbOver (src, __tmp) & dstMask;
		    FbDoWrite32 (*dst, __tmp, dst);
		}
	    }
	    else if (m)
				  ...
				  CARD16     height)
{
	...
	while (w--)
	{
		...
		{
		    FbDoWrite16 (d, *dst, dst);
		    d = fbOver24 (src, cvt0565to8888(d));
		}
		__tmp = cvt8888to0565(d);
		FbDoWrite16 (*dst, __tmp, dst);
	    }
	    else if (m)
	    {
		FbDoWrite16 (d, *dst, dst);
